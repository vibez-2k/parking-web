...
export function LoginForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div className={cn("flex min-h-screen flex-col items-center justify-center p-4", className)} {...props}>
      <Card className="w-full max-w-4xl overflow-hidden shadow-lg transition-shadow duration-300 hover:shadow-xl">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center space-y-2">
                ...
                <p className="text-balance text-muted-foreground">Login to your Thoothukudi parking account</p>
              </div>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className={cn(
                      ...
                      formErrors.email && "border-red-500 focus:ring-red-200"
                    )}
                    disabled={isLoading}
                  />
                  {formErrors.email && (
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className={cn(
                      "transition-all duration-200 focus:ring-2",
                      formErrors.password && "border-red-500 focus:ring-red-200"
                    )}
                    disabled={isLoading}
                  />
                  {formErrors.password && (
              ...
              <Button 
                type="submit" 
                className="w-full transition-all duration-200 text-black"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
              ...
              <div className="grid grid-cols-3 gap-3">
                <Button 
                  variant="outline" 
                  className="w-full transition-all hover:bg-muted/50 hover:scale-105"
                  disabled={isLoading}
                >
          ...
          <div className="relative hidden bg-white md:block">
            <Image
              ...
              className="absolute inset-0 h-full w-full object-contain transition-all duration-300 hover:scale-105"
              priority
            />
          </div>
        </CardContent>
      ...
      <div className="mt-4 text-balance text-center text-xs text-muted-foreground">
        ...
        <a href="#" className="text-primary hover:underline transition-colors">Terms of Service</a> and{" "}
